...
export class RegisterComponent implements OnInit {
  ...
  constructor(private router:Router,private formBuilder: FormBuilder,private authService:AuthService, private userService:UserService, private _snackbar:MatSnackBar) {
  ...
  private uploadPic() {
    ...
    this.userService.uploadPic(formData).subscribe((val) => {
      console.log(val)
